...
export const trainingElements  = ['TrainNormal', 'TrainRegression', 'TrainReinforce', 'TrainGan', 'TrainDetector'
  //'TrainGenetic',
  //'TrainDynamic',
  //'TrainLoss', 
  //'TrainOptimizer', 
];
export const deepLearnElements = ['DeepLearningFC', 'DeepLearningConv', 'DeepLearningRecurrent'];

export const pathWebWorkers = './workers';

export const baseUrlCloud  = 'https://perceptilabsamerica.azurewebsites.net/api/';
