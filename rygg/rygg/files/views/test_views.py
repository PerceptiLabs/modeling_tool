...
from rygg.files.views.github_view import (github_export, github_import)
...
class GithubImportTestCase(TestCaseBase):
    ...
    def test_path_required(self):
        with patch("rygg.files.views.github_view.import_repo", return_value=None) as import_repo_mock:
            with temp_local_dir("testing123") as d:
...
class GithubExportTestCase(TestCaseBase):
    ...
    def test_simple(self):
        with patch("rygg.files.views.github_view.connect_to_repo", return_value=Mock()),\
             patch("rygg.files.views.github_view.export_repo_basic", return_value=["2341234", "the_url"]),\
