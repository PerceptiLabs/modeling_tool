...
class BuildExportTests(TempFileTester, TestCase):
    ...
    def test_simple(self, create_readme_mock, mock_exporter_api):
        ...
        target.export_repo_basic("the token", "repo name", self.test_dir, False, [], commit_message="msg")
    ...
    def test_advanced(self, create_readme_mock, mock_exporter_api):
        ...
        target.export_repo_advanced("the token", "repo name", self.test_dir, [], [], [], commit_message="advanced msg")
