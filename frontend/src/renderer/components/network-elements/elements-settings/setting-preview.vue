...
.settings-layer
  .network-component-footer-wrapper(
    ...
    setting-outputs(
      ...
      :outputsVariables="outputsVariables"
    )
  ...
  computed: {
    ...
    showLoadingSpinner() {
      return (
        ...
        this.storeCurrentElement.chartDataIsLoading !== undefined &&
        this.storeCurrentElement.chartDataIsLoading !== 0
      );
    },
    layerId() {
    ...
    eLConnectionInElementChartData() {
      return this.$store.getters[
        "mod_workspace/GET_networkElementConnectionInChartData"
      ](this.layerId);
    },
    showModelPreviews() {
    ...
    chartData() {
      return (
        (this.storeCurrentElement && this.storeCurrentElement.chartData) || []
      );
    },
    outputsVariables() {
      return (
