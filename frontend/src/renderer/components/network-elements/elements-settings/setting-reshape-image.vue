...
.reshape-image_wrap(:style="styleWrap")
  .reshape-image(:class="{ 'reshape-image--3d': show3D }", :style="styleFront")
...
export default {
  ...
  computed: {
    ...
    axisX() {
      return this.axisSettings[0] / this.ratioNum;
    },
    axisY() {
      return this.axisSettings[1] / this.ratioNum;
    },
    axisZ() {
      return this.axisSettings[2] / this.ratioNum;
    },
    styleWrap() {
      if (this.show3D) {
        return {
