...
.statistics-box
  .statistics-box_main.statistics-box_col(
    v-if="computedCurrentTab === 'Generator_Loss'"
  )
    chart-switch(
      key="1",
  ...
  .statistics-box_main.statistics-box_col(
    v-if="computedCurrentTab === 'Discriminator_Loss'"
  )
    chart-switch(
      key="3",
  ...
  .statistics-box_main.statistics-box_col(
    v-if="computedCurrentTab === 'Samples'"
  )
    .statistics-box_row
  ...
  .statistics-box_main.statistics-box_col(
    v-if="computedCurrentTab === 'Data_distribution'"
  )
    chart-switch(
      key="11",
