  ...
  methods: {
    getData() {
      switch (this.currentTab) {
        case 'Weights & Output':
          this.chartRequest(this.networkElement.layerId, 'UNet', 'Weights&Output');
          break;
        case 'Bias':
          this.chartRequest(this.networkElement.layerId, 'UNet', 'Bias');
          break;
        case 'Gradients':
          this.chartRequest(this.networkElement.layerId, 'UNet', 'Gradients');
          break;
      }
    }
  },
