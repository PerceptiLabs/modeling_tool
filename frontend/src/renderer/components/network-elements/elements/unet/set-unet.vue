      ...
      .form_row
        ...
        .form_input
          base-radio(
            ...
            value-input="ReLU",
            v-model="settings.atten_activation"
          )
            span Relu
          base-radio(
            group-name="atten_activation",
    ...
    .form_row
      ...
      .form_input
        base-radio(
          ...
          :value-input="false",
          v-model="settings.output_activation"
        )
          span None
        base-radio(
          group-name="output_activation",
    ...
    .form_row
      ...
      .form_input
        base-radio(
          group-name="unpool",
          :value-input="false",
          v-model="settings.unpool"
        )
          span None
        base-radio(
          group-name="unpool",
          value-input="bilinear",
          v-model="settings.unpool"
        )
          span Bilinear
        base-radio(
  ...
  template(v-if="settings.backbone !== false")
    .settings-layer_section
      .form_row
        ...
        .form_input
          base-radio(
            group-name="backbone_weights",
            :value-input="true",
            v-model="settings.backbone_weights"
          )
            span Yes
          base-radio(
            group-name="backbone_weights",
    ...
    .settings-layer_section
      .form_row
        ...
        .form_input
          base-radio(
            group-name="freeze_backbone",
            :value-input="true",
            v-model="settings.freeze_backbone"
          )
            span Yes
          base-radio(
            group-name="freeze_backbone",
    ...
    .settings-layer_section
      .form_row
        ...
        .form_input
          base-radio(
            group-name="freeze_batch_norm",
            :value-input="true",
            v-model="settings.freeze_batch_norm"
          )
            span Yes
          base-radio(
            group-name="freeze_batch_norm",
