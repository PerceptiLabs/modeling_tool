...
header.app-header
  .app-header-section.app-header-left
    .app-header_logo
      img(
        src="./../../../../static/img/project-page/logo.svg",
        alt="PerceptiLabs logo"
      )
    .app-title
      span.bold PerceptiLabs
      | &nbsp;
      span.small {{ (appVersion === 'development' ? '' : 'v') + appVersion }}
  ...
  .app-header-section.app-header-right
    .help-button 
      base-switch-theme.switch-theme(
        :value="isThemeLight",
        :onClick="toggleTheme"
      )
    .help-button(@click="onToggleIntercom", tabindex="0") 
      svg(
        width="20",
        height="18",
        viewBox="0 0 20 18",
    ...
    .help-button(
      ...
      .dropdown.help-button-panel(v-if="showHelpPanel")
        .help-button-panel-content
          ...
          app-header-link(name="Tutorials", @handleClick="openVideoTutorials")
          app-header-link(
            name="Documentation",
            @handleClick="goToDocumentation"
          )
          hr.help-button-panel-content-item
          app-header-link(name="YouTube", @handleClick="onOpenYouTube")
...
export default {
  ...
  computed: {
    ...
    projectName() {
      ...
      let project = projectsList.filter(
        (project) => project.project_id === currentProject
      )[0];
