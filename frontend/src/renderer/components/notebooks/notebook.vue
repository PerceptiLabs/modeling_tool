...
export default {
  ...
  data() {
    return {
      notebookUrl:
        "http://192.168.180.136:8000/user/test/notebooks/Documents/Untitled.ipynb?token=f8c7dac1af8643ffb68f1d7e2869cf7a",
  ...
  methods: {
    updateNotebook() {
      Promise.all([
        ...
        const newNotebookJson = this.createNotebookDataToInject(
          notebookJson,
          sortedCode
        );
    ...
    fetchNetworkCode() {
      ...
      for (let networkElement of Object.entries(
