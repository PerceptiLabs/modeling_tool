<template lang="pug">
  .popup-global.z-100
    ...
    section.popup
      .popup-new-ui-header
        .popup-new-ui-header-text {{isInfo ? 'Info' : 'Error'}}
        svg.popup-new-ui-header-close-icon(width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg")
