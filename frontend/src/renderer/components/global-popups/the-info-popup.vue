<template lang="pug">
  .popup-global.z-100
    ...
    section.popup
      .popup-new-ui-header
        .popup-new-ui-header-text {{isInfo ? 'Info' : 'Warning'}}
