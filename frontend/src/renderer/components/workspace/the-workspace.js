...
export default {
  ...
  methods: {
    ...
    trainingFinished(index) {
      let networkStatus = this.workspace[index].networkMeta.coreStatus && this.workspace[index].networkMeta.coreStatus.Status;
    ...
    trainingWaiting(index) {
      return this.workspace[index].networkMeta.coreStatus && this.workspace[index].networkMeta.coreStatus.Status === 'Waiting';
    },
