      ...
      return [
        ...
        },
        {
          ...
          submenu: [
            ...
            {type:  'separator'},
            {label: 'Copy',         accelerator: this.isMac ? 'meta+c' : 'ctrl+c',              enabled: true,  active: this.HCCopy },
            {label: 'Paste',        accelerator: this.isMac ? 'meta+v' : 'ctrl+v',              enabled: true,  active: this.HCPaste },
            {type:  'separator'},
            {label: 'Select all',   accelerator: this.isMac ? 'meta+a' : 'ctrl+a',              enabled: true,  active: this.HCSelectAll },
            ...
            {label: 'add group',     accelerator: this.isMac ? 'meta+g' : 'ctrl+g',              enabled: true,  active: this.HC_addLayerContainer,         visible: true  },
