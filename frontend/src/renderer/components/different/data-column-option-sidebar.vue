      ...
      .main-content
        .mb-20
          ...
          .mt-10.image-random-option-select.d-flex.flex-column(
            ...
            base-radio.mb-5(
              :group-name="'normalizeTypeGroup' + elementIndex",
              value-input="standardization",
        ...
        template(v-if="helper_showIfTypeIs(['image', 'mask'])")
          .mb-20
            ...
            .mt-10.settings-layer_section.image-random-option-select.d-flex.flex-column(
              ...
              base-radio.mb-5(
                :group-name="'randomFlipTypeGroup' + elementIndex",
                value-input="vertical",
                v-model="options.random_flip.mode"
              )
                span Vertical
              base-radio.mb-5(
                :group-name="'randomFlipTypeGroup' + elementIndex",
              ...
              .form_row
                ...
                input.form_input(
                  type="text",
                  v-model="options.random_flip.seed"
                )
          .mb-20
            base-checkbox.bold.size-16(v-model="options.resize.value") Resize
            .pl-20.mt-10(v-if="options.resize.value")
              .d-flex.flex-column
                base-radio.mb-5(
                  :group-name="'resizeType' + elementIndex",
                  value-input="automatic",
                  v-model="options.resize.mode"
                )
                  span Automatic
                .pl-20.d-flex.flex-column(
                  v-if="options.resize.mode === 'automatic'"
                )
                  base-radio.mb-5(
                    :group-name="'resizeAutomaticType' + elementIndex",
                    value-input="mode",
                    v-model="options.resize.type"
                  )
                    span Dataset mode
                  base-radio.mb-5(
                    :group-name="'resizeAutomaticType' + elementIndex",
                ...
                base-radio.mb-5(
                  ...
                  span Custom
                .settings-layer_section.pl-20.d-flex.flex-column(
                  v-if="options.resize.mode === 'custom'"
                )
                  .form_row
          ...
          .mb-20
            base-checkbox.bold.size-16(v-model="options.random_rotation.value") Random rotation
            .settings-layer_section.mt-10.pl-20.d-flex.flex-column(
              v-if="options.random_rotation.value"
            )
              base-radio.mb-5(
                :group-name="'randomRotationTypeGroup' + elementIndex",
                value-input="reflect",
                v-model="options.random_rotation.fill_mode"
              )
                span Reflect
              base-radio.mb-5(
                :group-name="'randomRotationTypeGroup' + elementIndex",
              ...
              base-radio.mb-5(
                ...
                span Nearest
              .form_row(
                v-if="options.random_rotation.fill_mode === 'constant'"
              )
                label.form_label Fill:
                input.form_input(
                  type="number",
                  v-model="options.random_rotation.fill_value"
                )
              ...
              .form_row
                ...
                input.form_input(
                  type="number",
                  v-model="options.random_rotation.factor"
                )
              .form_row
                label.form_label Seed:
                input.form_input(
                  type="number",
                  v-model="options.random_rotation.seed"
                )
          .mb-20
            base-checkbox.bold.size-16(v-model="options.random_crop.value") Random Crop
            .settings-layer_section.mt-10.pl-25(
              v-if="options.random_crop.value"
            )
              .form_row
                label.form_label Seed:
                input.form_input.w-150(
                  type="text",
                  v-model="options.random_crop.seed"
                )
              .form_row
                label.form_label Width:
                input.form_input.w-150.text-left(
                  type="number",
                  min="1",
                  v-model="options.random_crop.width"
                )
              .form_row
                label.form_label Height:
                input.form_input.w-150.text-left(
...
export default {
    ...
    return {
      ...
      options: {
        ...
        random_rotation: {
          ...
          seed: 123,
          factor: 0,
        }, // fill_value = reflect|constant - fill_value|wrap|nearest
        resize: {
          value: true,
          width: 32,
          height: 32,
  ...
  methods: {
      ...
      if (this.helper_showIfTypeIs(["image", "mask"])) {
        ...
        if (this.options.random_rotation.value) {
          ...
          if (this.options.random_rotation.fill_mode === "constant") {
            saveResponse["random_rotation"]["fill_value"] = parseFloat(
              this.options.random_rotation.fill_value,
            );
          }
        }
      }
    ...
    onCancel() {
      this.$store.dispatch(
        "mod_dataWizardPreprocessing/TOGGLE_elementPreProcessing",
        null,
      );
    },
