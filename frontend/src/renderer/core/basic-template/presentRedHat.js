const presentRedHat = {
 "project": {},
 "network": {
   "networkName": "Red Hat Presentation",
   "networkID": "net1557230022943",
   "networkSettings": {
     "Epochs": "1",
     "Batch_size": "32",
     "MaxSteps": "1000",
   ...
   "networkElementList": [
     {
       ...
       "layerSettings": {
         ...
         "accessProperties": {
           ...
           "executeTime": 5.2081568241119385
         }
       },
       "layerCode": "",
       "layerMeta": {
     ...
     },
     {
       ...
       "layerSettings": {
         ...
         "accessProperties": {
           ...
           "executeTime": 0.030345678329467773
         }
       },
       "layerCode": "",
       "layerMeta": {
     ...
     {
       "layerId": "483179999999993",
       "layerName": "Softmax_1",
       "layerType": "Other",
       "layerSettings": {},
       "layerCode": "Y=tf.nn.softmax(X);",
       "layerMeta": {
         "isInvisible": false,
         "isLock": false,
         "isSelected": false,
