...
REPLICATED_PROPERTIES_TABLE = {
    ...
    GANLayer: [
        ...
        ReplicatedProperty('gen_loss_training', (np.float32, float), -1),
        ReplicatedProperty('gen_loss_validation', (np.float32, float), -1),        
        ReplicatedProperty('gen_loss_testing', (np.float32, float), -1),
        ReplicatedProperty('dis_loss_training', (np.float32, float), -1),
        ReplicatedProperty('dis_loss_validation', (np.float32, float), -1),        
        ReplicatedProperty('dis_loss_testing', (np.float32, float), -1),
        ReplicatedProperty('status', str, '<none>'),
        ReplicatedProperty('layer_gradients', dict, {}),
        ReplicatedProperty('layer_weights', dict, lambda _: dict()),
        ReplicatedProperty('layer_biases', dict, lambda _: dict()),
