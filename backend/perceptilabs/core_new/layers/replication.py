...
REPLICATED_PROPERTIES_TABLE = {
    Tf1xClassificationLayer: [
        ReplicatedProperty('sample', np.ndarray, lambda _: np.empty(())),
        ...
        ReplicatedProperty('accuracy_training', float, -1),
        ReplicatedProperty('accuracy_validation', float, -1),
        ReplicatedProperty('accuracy_testing', float, -1),
        ReplicatedProperty('loss_training', float, -1),
        ReplicatedProperty('loss_validation', float, -1),        
        ReplicatedProperty('loss_testing', float, -1),
        ...
        ReplicatedProperty('progress', float, -1),
    ],
    DataLayer: [
        ReplicatedProperty('sample', int, lambda _: np.empty(())),
        ReplicatedProperty('size_training', int, -1),
        ReplicatedProperty('size_validation', int, -1),
        ReplicatedProperty('size_testing', int, -1),
        ReplicatedProperty('variables', dict, lambda _: dict())
