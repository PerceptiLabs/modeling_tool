...
REPLICATED_PROPERTIES_TABLE = {
    ClassificationLayer: [
        ...
        ReplicatedProperty('auc_training', (np.float32, float), -1),
        ReplicatedProperty('auc_validation', (np.float32, float), -1),
    ...
    RegressionLayer: [
        ReplicatedProperty('epoch', int, -1),
        ReplicatedProperty('squared_error_training', (np.float32, float), -1),
        ReplicatedProperty('squared_error_validation', (np.float32, float), -1),        
        ReplicatedProperty('squared_error_testing', (np.float32, float), -1),
        ReplicatedProperty('squared_variance_training', (np.float32, float), -1),
        ReplicatedProperty('squared_variance_validation', (np.float32, float), -1),        
        ReplicatedProperty('squared_variance_testing', (np.float32, float), -1),
        ReplicatedProperty('r_squared_training', (np.float32, float), -1),
        ReplicatedProperty('r_squared_validation', (np.float32, float), -1),        
        ReplicatedProperty('r_squared_testing', (np.float32, float), -1),
        ReplicatedProperty('status', str, '<none>'),
        ReplicatedProperty('layer_gradients', dict, lambda _: dict()),
        ReplicatedProperty('training_iteration', int, -1),
        ReplicatedProperty('validation_iteration', int, -1),
    ...
    RLLayer: [
        ...
        ReplicatedProperty('gamma', (np.float32, float), -1),
        ReplicatedProperty('replay_memory_size', int, -1),
        ReplicatedProperty('transition', dict, {}),
        ReplicatedProperty('n_steps_max', int, -1),
        ReplicatedProperty('step_counter', int, -1),
        ReplicatedProperty('history_length', int, -1),
        ReplicatedProperty('variables', dict, lambda _: dict()),
        ReplicatedProperty('loss_training', (np.float32, float), -1),
        ReplicatedProperty('loss_validation', (np.float32, float), -1),        
        ReplicatedProperty('loss_testing', (np.float32, float), -1),
    ...
    GANLayer: [
        ...
        ReplicatedProperty('epoch', int, -1),        
        ReplicatedProperty('variables', dict, lambda _: dict()),
        ReplicatedProperty('get_switch_layer_id', str, " "),
        ReplicatedProperty('generator_loss_training', (np.float32, float), -1),
        ReplicatedProperty('generator_loss_validation', (np.float32, float), -1),        
        ReplicatedProperty('generator_loss_testing', (np.float32, float), -1),
        ReplicatedProperty('discriminator_loss_training', (np.float32, float), -1),
        ReplicatedProperty('discriminator_loss_validation', (np.float32, float), -1),        
        ReplicatedProperty('discriminator_loss_testing', (np.float32, float), -1),
        ReplicatedProperty('status', str, '<none>'),
        ReplicatedProperty('layer_gradients', dict, {}),
        ReplicatedProperty('layer_weights', dict, lambda _: dict()),
        ReplicatedProperty('layer_biases', dict, lambda _: dict()),
        ReplicatedProperty('layer_outputs', dict, lambda _: dict()),
        ReplicatedProperty('generator_layer_outputs', dict, lambda _: dict()),
