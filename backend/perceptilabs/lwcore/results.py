class LayerResults:
    ...
    def __eq__(self, other):
        if (
            ...
            or self.trained != other.trained
            or self.code_error != other.code_error
            or self.instantiation_error != other.instantiation_error
            or self.strategy_error != other.strategy_error
        ):
            return False
