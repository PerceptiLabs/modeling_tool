...
def test_io_layer_samples_are_from_the_same_row(file_access, csv_path, graph_spec, x1, y1):
    feature_specs = {
...
def test_output_layer_raises_error_if_inputs_shape_doesnt_match(file_access, csv_path, graph_spec_faulty, x1, y1):
    feature_specs = {
            'x1': FeatureSpec(datatype='numerical', iotype='input'),
            'y1': FeatureSpec(datatype='numerical', iotype='target')
    }
