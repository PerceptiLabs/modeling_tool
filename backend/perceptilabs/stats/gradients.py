...
class GradientStats(TrainingStats):
    ...
    def __eq__(self, other):
        return (
            self.minimum_series == other.minimum_series
            and self.average_series == other.average_series
            and self.maximum_series == other.maximum_series
        )
...
class GradientStatsTracker(TrainingStatsTracker):
    ...
    def __eq__(self, other):
        return (
            self.minimum_gradient == other.minimum_gradient
            and self.average_gradient == other.average_gradient
            and self.maximum_gradient == other.maximum_gradient
        )
