...
class RSquaredStats:
    ...
    def get_r_squared_over_steps_in_latest_epoch(self, phase="training"):
        ...
        r_squared_values = self.get_r_squared_over_steps(
            epoch=len(self.r_squared_values) - 1, phase=phase
        )
        return r_squared_values
