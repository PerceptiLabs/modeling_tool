...
class GraphSpecBuilder:
    ...
    def add_connection(
        self, source_id: str, source_var: str, dest_id: str, dest_var: str
    ):
        ...
        connection = LayerConnection(
            src_id=source_id, src_var=source_var, dst_id=dest_id, dst_var=dest_var
        )
    ...
    def build(self) -> GraphSpec:
        ...
        Returns:
            A graph spec
        """
        layer_specs = [self._build_layer(layer_id) for layer_id in self._layers]
