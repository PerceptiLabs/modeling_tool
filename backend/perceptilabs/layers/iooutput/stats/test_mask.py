...
def test_stats_objects_are_equal_when_args_are_equal():
    ...
    def setup(arg1=1, arg2=2, arg3=3, arg4=4, arg5=5, arg6=6):
...
def test_trackers_are_equal_when_both_are_updated(y_pred, y_true, x):
    tracker1 = MaskOutputStatsTracker()
    tracker2 = MaskOutputStatsTracker()
...
def test_serialized_trackers_are_equal(y_pred, y_true, x):
    tracker1 = MaskOutputStatsTracker()
    tracker1.update(
        predictions_batch=y_pred,
        targets_batch=y_true,
