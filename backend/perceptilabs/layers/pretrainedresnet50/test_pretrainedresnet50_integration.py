...
@pytest.mark.parametrize('pooling',['None', 'avg', 'max'])
def test_resnet50_output_changes_in_training_mode_with_training_argument(script_factory, pooling):
    layer_spec = PreTrainedResNet50Spec(
        id_='layer_id',
        name='layer_name',
        include_top=False,
...
@pytest.mark.parametrize('pooling',['None', 'avg', 'max'])
def test_resnet50_output_doesnot_change_in_inference_mode_with_training_argument(script_factory, pooling):
    layer_spec = PreTrainedResNet50Spec(
        id_='layer_id',
        name='layer_name',
        include_top=False,
