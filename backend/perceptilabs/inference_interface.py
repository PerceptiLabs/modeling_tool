...
class InferenceInterface:
    def __init__(self, task_executor, message_broker, testing_results_access, serving_results_access, max_serving_ttl=None):
    ...
    def start_serving(self, call_context, serving_settings, dataset_settings_dict, model_id, training_session_id, model_name, ttl, graph_settings=None, logrocket_url=''):
    ...
    def start_testing(self, call_context, models_info, tests, logrocket_url=''):
        ...
        self._task_executor.enqueue(
            'testing_task', call_context, testing_session_id, models_info, tests, logrocket_url=logrocket_url)
